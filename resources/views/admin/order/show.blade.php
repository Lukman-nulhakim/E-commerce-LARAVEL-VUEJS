            ...
            <div class="col-md-12">
                <div class="card border-0 shadow">
                    <div class="card-header">
                        <h6 class="m-0 font-weight-bold"><i class="fas fa-shopping-cart"></i> DETAIL ORDERS</h6>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        {{ $invoice->courier }} / {{ $invoice->servive }} / {{ moneyFormat($invoice->cost_courier) }}
                                    </td>
                                </tr>
                                <tr>
