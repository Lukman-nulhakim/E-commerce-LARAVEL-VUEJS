                ...
                <div class="card border-0 shadow">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.slider.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>LINK</label>
                                <input type="file" name="link" value="{{ old('link') }}" placeholder="Masukan Link" class="form-control @error('link') is-invalid @enderror">
                                ...
                                <tbody>
                                    @forelse ($sliders as $no => $slider)
                                        <tr>
                                            ...
                                            <td>{{ $slider->link }}</td>
                                            <td class="text-center">
                                                <button onClick="Delete(this.id)" class="btn btn-sm btn-danger" id="{{ $slider->id }}"><i class="fa fa-trash"></i></button>
                                            </td>
                                        </tr>
                                    @empty
